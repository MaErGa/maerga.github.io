...
switch(archive){
    ...
    file = { 
        ...
        firstMpMin: 254, firstMpMax: 304,firstLevelBar: 40, firstLimitBar: 176, firstLimitLevel: 3, firstActive: "yes",
...
//Characters image.
file.firstName != ""? document.querySelector("#firstPosition").src = urlData(file.firstName):document.querySelector("#firstPosition").src = "//:0";
file.secondName != ""? document.querySelector("#secondPosition").src = urlData(file.secondName):document.querySelector("#secondPosition").src = "//:0";
file.thirdName != ""?document.querySelector("#thirdPosition").src = urlData(file.thirdName):document.querySelector("#thirdPosition").src = "//:0";
...
// This function is only in codepen version, It will translate the name and music from files to Dropbox urls.
function urlData(data){
    ...
    switch (data){
        ...
        case "Cloud":
        url = "https://www.dropbox.com/s/p566d1ub569wi2u/Cloud.jpg?raw=1";
    
        break;
        case "Barret":
        url = "https://www.dropbox.com/s/9w8nh7tbjm16bws/Barret.jpg?raw=1";
    
        break;
        case "Tifa":
        url = "https://www.dropbox.com/s/rwhixlwp2qk0wdz/Tifa.jpg?raw=1";
    
        break;
        case "Aerith":
        url = "https://www.dropbox.com/s/lkad5436banfzg1/Aerith.jpg?raw=1";
    
        break;
        case "Cait Sith":
        url = "https://www.dropbox.com/s/zd8yecv3amdp9hl/Cait%20Sith.jpg?raw=1";
    
        break;
        case "Yuffie":
        url = "https://www.dropbox.com/s/g7bzugzdsiz7qvp/Yuffie.jpg?raw=1";
    
        break;
        case "Cid":
        url = "https://www.dropbox.com/s/y3pf5oan0r1c3q4/Cid.jpg?raw=1";
    
        break;
        case "Red XIII":
        url = "https://www.dropbox.com/s/csexvp3jdx2xjbw/Red%20XIII.jpg?raw=1";
    
        break;
        case "Vincent":
        url = "https://www.dropbox.com/s/onufwoy5jed05m8/Vincent.jpg?raw=1";
    
        break;
        case "Barret's Theme":
        url = "https://www.dropbox.com/s/9x1mavi1pes6f28/Barret%27s%20Theme.mp3?raw=1";
    
        break;
        case "Flowers Blooming in the Church":
        url = "https://www.dropbox.com/s/0wn2xcjez94c07b/Flowers%20Blooming%20in%20the%20Church.mp3?raw=1";
    
        break;
        case "Cait Sith's Theme":
        url = "https://www.dropbox.com/s/47m5x08y72e8tad/Cait%20Sith%27s%20Theme.mp3?raw=1";
    
        break;
        case "You Can Hear the Cry of the Planet":
        url = "https://www.dropbox.com/s/bav5r6sa1xuqmbu/You%20Can%20Hear%20the%20Cry%20of%20the%20Planet.mp3?raw=1";
    
        break;
        case "Judgement Day":
        url = "https://www.dropbox.com/s/172yy3tyolk2ecn/Judgement%20Day.mp3?raw=1";
